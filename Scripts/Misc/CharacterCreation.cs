...
namespace Server.Misc
{
	...
	{
		//Maximum number of Welcome Back Skillballs
        private const int MAXIMUM_WELCOME_BACK_SKILLBALLS = 3;
		...
		private static void FillBankbox( Mobile m )
		{
			...
			if ( bank != null )
			{
				...
				//bank.DropItem( MakeNewbie( new Gold( 1000 ) ) );
