...
namespace Server.Misc
{
	public class RegenRates
	{
		...
		private static TimeSpan Mobile_ManaRegenRate( Mobile from )
		{
			...
			else
			{
				...
				if ( medPoints <= 0 )
					...
					rate = 7.0 - (244*medPoints/2400) + (19*medPoints*medPoints/48000);
		...
		private static double GetArmorMeditationValue( BaseArmor ar )
		{
			...
			{
				default:
				case ArmorMeditationAllowance.None: return ar.ArmorRating;
				case ArmorMeditationAllowance.Half: return ar.ArmorRating / 2.0;
