...
{
	public class PvpRewardVendor : Mobile
	{
  	[Constructable]
		public PvpRewardVendor( ) : base( )
		{
			InitBody();
			InitOutfit();
		}

		public PvpRewardVendor( Serial serial ) : base( serial )
		{
		}
		...
		{
			public BuyVendorEntry( PvpRewardVendor vendor ) : base( 6103 )
			{
			}
