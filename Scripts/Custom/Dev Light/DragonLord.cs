...
namespace Server.Mobiles
{
	...
	public class DragonLord : BaseCreature
	{
		...
		[Constructable]
		public DragonLord () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a dragon lord";
			Body = 49;
			BaseSoundID = 362;
			...
			{
			case 0: PackItem( new MarbleStatueMaker() ); break;
		...
		{
			private DragonLord d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, DragonLord owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
