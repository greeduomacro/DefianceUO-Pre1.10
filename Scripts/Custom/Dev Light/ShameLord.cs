...
{
	[CorpseName( "a shame royal lord" )]
	public class ShameLord : BaseCreature
	{
		public Timer m_DeathTimer;

		[Constructable]
		public ShameLord () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a shame royal lord";
			Body = 311;
			BaseSoundID = 362;
			Hue = 1126;
			//DamageMax 25;
			...
			{
			case 0: PackItem( new JadeStatueMaker() ); break;
		...
		public ShameLord( Serial serial ) : base( serial )
		{
		}
		...
		private class BreatheTimer : Timer
		{
			...
			public BreatheTimer( Mobile m, ShameLord owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
