...
namespace Server.Mobiles
{
	...
	public class RoyalSkeletalKnight : BaseCreature
	{
		[Constructable]
		public RoyalSkeletalKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a royal skeletal knight";
			Body = 147;
			BaseSoundID = 451;
			Hue = 2401;
		...
		public RoyalSkeletalKnight( Serial serial ) : base( serial )
		{
		}
