...
namespace Server.Items
{
	public class OrderStone : Item
	{
		...
		public OrderStone( Guild g ) : base( 0xEDC )
		{
			m_Guild = g;
		...
		public OrderStone( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			from.SendMessage( 0x35, "You are now a member of Order. To Resign say 'i resign from my guild'.");

			if ( from.Backpack != null )
			{
				Item m_item = from.Backpack.FindItemByType(typeof(OrderShield), true);
				if ( m_item == null )
				{
					from.Backpack.DropItem( new OrderShield() );
					from.SendMessage( 0x35, "You receive an Order Shield");
				}
			}
		}
	}
