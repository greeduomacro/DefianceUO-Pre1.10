...
namespace Server.Items
{
	...
	public class NoBlowBlessingDagger : BaseKnife
	{
		...
		[Constructable]
		public NoBlowBlessingDagger() : base( 0xF52 )
		{
			Weight = 1.0;
			Name = "[Dagger of Blessing] has a 14% chance to bless the wielder.";
		}

		public NoBlowBlessingDagger( Serial serial ) : base( serial )
		{
		}
