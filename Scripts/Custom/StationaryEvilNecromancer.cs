...
namespace Server.Mobiles
{
	...
	public class StationaryEvilNecromancer : BaseCreature
	{
		[Constructable]
		public StationaryEvilNecromancer () : base( AIType.AI_Healer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			CantWalk = true;
			Team = 2;
			Name = "Necromancer [Crystal Bearer]";
			Kills = 5;
			Body = 400;
			BaseSoundID = 0x45A;
			Hue = 33;
			...
			SetSkill( SkillName.Magery, 85.1, 95.5 );
...
//////
		public StationaryEvilNecromancer( Serial serial ) : base( serial )
		{
		}
