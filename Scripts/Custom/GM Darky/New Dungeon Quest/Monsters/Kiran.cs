...
namespace Server.Mobiles
{
	...
	public class Kiran : BaseCreature
	{
		[Constructable]
		public Kiran() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Kiran";
			Body = 788;
		...
		public Kiran( Serial serial ) : base( serial )
		{
		}
