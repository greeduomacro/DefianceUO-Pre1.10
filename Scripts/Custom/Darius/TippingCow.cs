...
namespace Server.Mobiles
{
	...
	public class TippingCow : BaseCreature
	{
		[Constructable]
		public TippingCow() : base( AIType.AI_Animal, FightMode.Agressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a cow";
		...
		public TippingCow(Serial serial) : base(serial)
		{
		}
