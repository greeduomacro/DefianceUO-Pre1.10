...
namespace Server.Items
{
   ...
   private class InternalTarget : Target
      ...
      public InternalTarget(CannonFire m_can) : base( 20, true, TargetFlags.None )
         ...
         new DelayTimer( from, time ).Start();
            ...
            from.SendMessage( "The cannon is too hot! You must wait 5 seconds before firing again.", from);
   ...
   public class Cannon2 : BaseAddon
   {
   private int m_Dir;
   ...
   public override BaseAddonDeed Deed{ get{ return new CannonDeed(m_Dir); } }
         [Constructable]
         public Cannon2(int dir) // 1 = North - 2 = South - 3 = East - 4 = West
            {
            Name = "Cannon";
            switch (dir)
         {
   ...
   public Cannon2( Serial serial ) : base( serial )
      {
      }
   ...
   public class CannonDeed : BaseAddonDeed
   {
   private int m_Dir;
   ...
   public int Dir{ get{ return m_Dir; } set{ m_Dir = value; } }
      ...
      public override BaseAddon Addon{ get{ return new Cannon2(m_Dir); } }

      [Constructable]
      public CannonDeed(int dir)// 1 = North - 2 = South - 3 = East - 4 = West
      {
      Dir = dir;
      switch (dir)
         {
         case 1: Name = "Cannon deed facing north"; break;
         case 2: Name = "Cannon deed facing south"; break;
         case 3: Name = "Cannon deed facing east"; break;
         case 4: Name = "Cannon deed facing west"; break;
         }
      }
