		...
		private class InternalGump : Gump
		{
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				switch ( info.ButtonID )
				{
					...
					case 2: item = new EtherealWarSteed(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 3: item = new EtherealWolfRider(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
