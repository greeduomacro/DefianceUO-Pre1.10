...
{
	public class MetalHueBundleTicket : Item
	{
		...
		[Constructable]
		public MetalHueBundleTicket() : base( 0x14F0 )
		{
			Weight = 6.0;
			LootType = LootType.Blessed;
			Name = "a donation metal bundle ticket";
			Hue = 1158;
		}

		public MetalHueBundleTicket( Serial serial ) : base( serial )
		{
		}
		...
		{
			private MetalHueBundleTicket m_Ticket;

			public InternalTarget( MetalHueBundleTicket ticket ) : base( 2, false, TargetFlags.None )
			{
				m_Ticket = ticket;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( targeted is MetalHueBundleTicket )
				{
					MetalHueBundleTicket theirTicket = targeted as MetalHueBundleTicket;
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( Mobile from, MetalHueBundleTicket ticket ) : base( 50, 50 )
			{
				m_From = from;
				m_Ticket = ticket;
				...
				AddHtml(80,129,240,24,"Agapite Colored Bundle.",true,false);
				...
				AddButton( 46, 303, 0xFA5, 0xFA7, 6, GumpButtonType.Reply, 0 );
                                AddHtml(80,304,240,24,"Shadow Colored Bundle.",true,false);
				//AddLabel( 50, 320, 0x489, "Shadow Colored Bundle" );  //# 1test
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				{
					case 1: item = new ApagiteDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					...
					case 6: item = new ShadowDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
				}
