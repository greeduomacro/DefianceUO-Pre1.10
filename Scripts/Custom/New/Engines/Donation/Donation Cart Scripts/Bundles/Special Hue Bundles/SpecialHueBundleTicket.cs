...
{
	public class SpecialHueBundleTicket : Item
	{
		...
		[Constructable]
		public SpecialHueBundleTicket() : base( 0x14F0 )
		{
			Weight = 6.0;
			LootType = LootType.Blessed;
			Name = "a donation special bundle ticket";
			Hue = 1158;
		}

		public SpecialHueBundleTicket( Serial serial ) : base( serial )
		{
		}
		...
		{
			private SpecialHueBundleTicket m_Ticket;

			public InternalTarget( SpecialHueBundleTicket ticket ) : base( 2, false, TargetFlags.None )
			{
				m_Ticket = ticket;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( targeted is SpecialHueBundleTicket )
				{
					SpecialHueBundleTicket theirTicket = targeted as SpecialHueBundleTicket;
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( Mobile from, SpecialHueBundleTicket ticket ) : base( 50, 50 )
			{
				m_From = from;
				m_Ticket = ticket;
				...
				AddHtml(80,129,240,24,"Dark Blue Colored Bundle.",true,false);
				//AddLabel( 80, 128, 0x489, "Dark Blue Colored Bundle." );  //# 1test

				AddButton( 46, 163, 0xFA5, 0xFA7, 2, GumpButtonType.Reply, 0 );
				AddHtml(80,164,240,24,"Pink Colored Bundle.",true,false);
				//AddLabel( 80, 163, 0x489, "Pink Colored Bundle." );  //# 1test

				AddButton( 46, 198, 0xFA5, 0xFA7, 3, GumpButtonType.Reply, 0 );
				AddHtml(80,199,240,24,"Dark Red Colored Bundle.",true,false);
				//AddLabel( 80, 198, 0x489, "Dark Red Colored Bundle." );  //# 1test

				AddButton( 46, 233, 0xFA5, 0xFA7, 4, GumpButtonType.Reply, 0 );
				AddHtml(80,234,240,24,"Olive Colored Bundle.",true,false);
				//AddLabel( 80, 233, 0x489, "Olive Colored Bundle." );  //# 1test

				AddButton( 46, 268, 0xFA5, 0xFA7, 5, GumpButtonType.Reply, 0 );
				AddHtml(80,269,240,24,"Purple Colored Bundle.",true,false);
				//AddLabel( 80, 268, 0x489, "Purple Colored Bundle." );  //# 1test
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				{
					case 1: item = new DarkblueDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 2: item = new PinkDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 3: item = new DarkRedDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 4: item = new OliveDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 5: item = new PurpleDonationBox(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
