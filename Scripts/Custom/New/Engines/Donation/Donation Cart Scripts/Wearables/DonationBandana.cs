...
{
	public class DonationBandana : Bandana
	{
		[Constructable]
		public DonationBandana() : this( 0 )
		{
		}

		[Constructable]
		public DonationBandana( int hue ) : base( hue )
		{
			Weight = 1.0;
                        Hue = 1177;
		...
		public DonationBandana( Serial serial ) : base( serial )
		{
		}
