...
namespace Arya.Jail
{
	...
	public class JailSystem
	{
		...
		public static void Initialize()
		{
			...
			// Commands
			Server.Commands.Register( "Jail", m_MinLevel, new CommandEventHandler( OnJailCommand ) );
			Server.Commands.Register( "JailInfo", AccessLevel.Player, new CommandEventHandler( OnJailInfoCommand ) );
		...
		public static ArrayList SearchForAccounts( string account )
		{
			...
			foreach( Account cmp in Accounts.Table.Values )
			{
