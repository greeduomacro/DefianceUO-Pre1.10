...
{
	public class PokerLowRollerTicket : Item
	{
		...
		[Constructable]
		public PokerLowRollerTicket() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "a poker low roller entry ticket";
			Hue = 1367;
		}

		public PokerLowRollerTicket( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump1 : Gump
		{
			...
			public InternalGump1( Mobile from, PokerLowRollerTicket ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
			...
			AddHtml( 28, 45, 340, 70, @"This is a poker entry ticket for a low roller tournament table.",true,true);
