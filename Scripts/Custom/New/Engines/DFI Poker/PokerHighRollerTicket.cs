...
{
	public class PokerHighRollerTicket : Item
	{
		...
		[Constructable]
		public PokerHighRollerTicket() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
			Name = "a poker high roller entry ticket";
			Hue = 1367;
		}

		public PokerHighRollerTicket( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump1 : Gump
		{
			...
			public InternalGump1( Mobile from, PokerHighRollerTicket ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
			...
			AddHtml( 28, 45, 340, 70, @"This is a poker entry ticket for a high roller tournament table.",true,true);
