...
{
	public class AssassinationGorget : BaseArmor
	{
		...
		[Constructable]
		public AssassinationGorget() : base( 0x13D6 )
		{
                        Name = "Assassination Collar [Lieutenant]";
			Weight = 5.0;
                        Hue = 1269;
		}

		public AssassinationGorget( Serial serial ) : base( serial )
		{
		}
