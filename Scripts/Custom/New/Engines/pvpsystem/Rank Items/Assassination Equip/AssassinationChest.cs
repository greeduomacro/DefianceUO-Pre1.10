...
{
	public class AssassinationChest : BaseArmor
	{
		...
		[Constructable]
		public AssassinationChest() : base( 0x144F )
		{
                        Name = "Assassination Tunic [Grand Marshal]";
			Weight = 5.0;
                        Hue = 1269;
		}

		public AssassinationChest( Serial serial ) : base( serial )
		{
		}
