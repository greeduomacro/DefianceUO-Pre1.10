...
{
	public class AssassinationLegs : BaseArmor
	{
		...
		[Constructable]
		public AssassinationLegs() : base( 0x1452 )
		{
                        Name = "Assassination Legthreads [Grand Commander]";
			Weight = 5.0;
                        Hue = 1269;
		}

		public AssassinationLegs( Serial serial ) : base( serial )
		{
		}
