...
{
	public class AssassinationGloves : BaseArmor
	{
		...
		[Constructable]
		public AssassinationGloves() : base( 0x1450 )
		{
                        Name = "Assassination Handwraps [Mercenary]";
			Weight = 5.0;
                        Hue = 1269;
		}

		public AssassinationGloves( Serial serial ) : base( serial )
		{
		}
