...
{
	public class MostResKillersGump : Gump
	{
		public MostResKillersGump() : base( 0, 0 )
		{
			FSPvpSystem.CheckTopResKillers();
			...
			AddHtml( 44, 26, 423, 37, @"<BASEFONT COLOR=WHITE><CENTER>Player vs. Player Scoreboard<BR>Top 20 Res Killers</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 44, 70, 252, 23, @"<BASEFONT COLOR=WHITE><CENTER>Player Names</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 303, 70, 77, 23, @"<BASEFONT COLOR=WHITE><CENTER>Res Kills</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 388, 70, 79, 23, @"<BASEFONT COLOR=WHITE><CENTER>Guild</CENTER></BASEFONT>", (bool)false, (bool)false);

			ArrayList list = FSPvpSystem.ResKillers;
			...
			int listPage = 0;
				...
				AddLabel(310, offset, 1149, ps.ResKills.ToString() );
