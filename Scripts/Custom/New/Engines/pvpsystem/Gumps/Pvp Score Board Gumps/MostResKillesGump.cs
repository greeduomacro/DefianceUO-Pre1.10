...
{
	public class MostResKilliesGump : Gump
	{
		public MostResKilliesGump() : base( 0, 0 )
		{
			FSPvpSystem.CheckTopResKillies();
			...
			AddHtml( 44, 26, 423, 37, @"<BASEFONT COLOR=WHITE><CENTER>Player vs. Player Scoreboard<BR>Top 20 Res Killed</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 44, 70, 252, 23, @"<BASEFONT COLOR=WHITE><CENTER>Player Names</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 303, 70, 77, 23, @"<BASEFONT COLOR=WHITE><CENTER>Res Killed</CENTER></BASEFONT>", (bool)false, (bool)false);
			AddHtml( 388, 70, 79, 23, @"<BASEFONT COLOR=WHITE><CENTER>Guild</CENTER></BASEFONT>", (bool)false, (bool)false);

			ArrayList list = FSPvpSystem.ResKillies;
			...
			int listPage = 0;
				...
				AddLabel(310, offset, 1149, ps.ResKilled.ToString() );
