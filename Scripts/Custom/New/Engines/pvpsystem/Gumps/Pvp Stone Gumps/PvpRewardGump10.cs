...
{
	public class PvpRewardGump10 : Gump
	{
		private string m_GumpTitle = "Grand General Equipment";
		private string m_Item1 = "Assassination Arms";
		private string m_Item2 = "BattleMage Arms";
		private string m_Item3 = "Field Warrior Arms";
		private string m_Item4 = "Empty";
		private string m_Item5 = "Empty";
		private int m_Cost1 = 2500;
		private int m_Cost2 = 2500;
		private int m_Cost3 = 2500;
		private int m_Cost4 = 1;
		private int m_Cost5 = 1;

		public PvpRewardGump10() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
        		...
        		if ( info.ButtonID == 1 )
         		{
		   		...
		   		{
					from.AddToBackpack( new AssassinationArms() );
        		...
        		if ( info.ButtonID == 2 )
         		{
		   		...
		   		{
					from.AddToBackpack( new BattleArms() );
					from.SendMessage( msg2 );
				}
        		...
        		if ( info.ButtonID == 3 )
         		{
		   		...
		   		{
					from.AddToBackpack( new FieldArms() );
					from.SendMessage( msg2 );
				}
