...
{
	public class PvpRewardGump12 : Gump
	{
		private string m_GumpTitle = "Grand Marshal";
		private string m_Item1 = "Assassination Tunic";
		private string m_Item2 = "BattleMage Tunic";
		private string m_Item3 = "Field Warrior Tunic";
		private string m_Item4 = "Empty";
		private string m_Item5 = "Empty";
		private int m_Cost1 = 3000;
		private int m_Cost2 = 3000;
		private int m_Cost3 = 3000;
		private int m_Cost4 = 1;
		private int m_Cost5 = 1;

		public PvpRewardGump12() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
        		...
        		if ( info.ButtonID == 1 )
         		{
		   		...
		   		{
					from.AddToBackpack( new AssassinationChest() );
        		...
        		if ( info.ButtonID == 2 )
         		{
		   		...
		   		{
					from.AddToBackpack( new BattleChest() );
					from.SendMessage( msg2 );
				}
        		...
        		if ( info.ButtonID == 3 )
         		{
		   		...
		   		{
					from.AddToBackpack( new FieldChest() );
					from.SendMessage( msg2 );
				}
