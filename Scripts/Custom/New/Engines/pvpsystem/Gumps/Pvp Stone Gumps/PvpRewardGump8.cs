...
{
	public class PvpRewardGump8 : Gump
	{
		private string m_GumpTitle = "Grand Commander Equipment";
		private string m_Item1 = "Assassination Leggins";
		private string m_Item2 = "BattleMage Leggins";
		private string m_Item3 = "Field Warriors Leggins";
		private string m_Item4 = "Empty";
		private string m_Item5 = "Empty";
		private int m_Cost1 = 2000;
		private int m_Cost2 = 2000;
		private int m_Cost3 = 2000;
		private int m_Cost4 = 1;
		private int m_Cost5 = 1;

		public PvpRewardGump8() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
        		...
        		if ( info.ButtonID == 1 )
         		{
		   		...
		   		{
					from.AddToBackpack( new AssassinationLegs() );
        		...
        		if ( info.ButtonID == 2 )
         		{
		   		...
		   		{
					from.AddToBackpack( new BattleLegs() );
					from.SendMessage( msg2 );
				}
        		...
        		if ( info.ButtonID == 3 )
         		{
		   		...
		   		{
					from.AddToBackpack( new FieldLegs() );
					from.SendMessage( msg2 );
				}
