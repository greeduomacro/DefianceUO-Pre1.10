...
{
	public class PvpRewardGump6 : Gump
	{
		private string m_GumpTitle = "Grand Captain Equipment";
		private string m_Item1 = "Assassination Circlet";
		private string m_Item2 = "BattleMage Circlet";
		private string m_Item3 = "Field Warriors Circlet";
		private string m_Item4 = "Empty";
		private string m_Item5 = "Empty";
		private int m_Cost1 = 1500;
		private int m_Cost2 = 1500;
		private int m_Cost3 = 1500;
		private int m_Cost4 = 1;
		private int m_Cost5 = 1;

		public PvpRewardGump6() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
        		...
        		if ( info.ButtonID == 1 )
         		{
		   		...
		   		{
					from.AddToBackpack( new AssassinationHelm() );
        		...
        		if ( info.ButtonID == 2 )
         		{
		   		...
		   		{
					from.AddToBackpack( new BattleHelm() );
					from.SendMessage( msg2 );
				}
        		...
        		if ( info.ButtonID == 3 )
         		{
		   		...
		   		{
					from.AddToBackpack( new FieldHelm() );
					from.SendMessage( msg2 );
				}
