...
{
	public class PvpRewardGump2 : Gump
	{
		private string m_GumpTitle = "Mercenaries Equipment";
		private string m_Item1 = "BattleMage Gloves";
		private string m_Item2 = "FieldFighter Gloves";
		private string m_Item3 = "Assassination Gloves";
		private string m_Item4 = "Empty";
		private string m_Item5 = "Empty";
		private int m_Cost1 = 500;
		private int m_Cost2 = 500;
		private int m_Cost3 = 500;
		private int m_Cost4 = 1;
		private int m_Cost5 = 1;

		public PvpRewardGump2() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
        		...
        		if ( info.ButtonID == 1 )
         		{
		   		...
		   		{
					from.AddToBackpack( new BattleGloves() );
        		...
        		if ( info.ButtonID == 2 )
         		{
		   		...
		   		{
					from.AddToBackpack( new FieldGloves() );
					from.SendMessage( msg2 );
				}
        		...
        		if ( info.ButtonID == 3 )
         		{
		   		...
		   		{
					from.AddToBackpack( new AssassinationGloves() );
					from.SendMessage( msg2 );
				}
