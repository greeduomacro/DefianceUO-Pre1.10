...
{
	public class SmallReward5 : Item
	{
		...
		[Constructable]
		public SmallReward5() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public SmallReward5( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump5( from, this ) );
			}
		}

		private class InternalGump5 : Gump
		{

			public InternalGump5( Mobile from, SmallReward5 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
			...
			AddHtml( 28, 45, 340, 70, @"This is a small BOD Reward Ticket, this will be replaced by a reward in the near future.",true,true);
