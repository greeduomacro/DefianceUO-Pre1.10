...
{
	public class SmallReward2 : Item
	{
		...
		[Constructable]
		public SmallReward2() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public SmallReward2( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump2( from, this ) );
			}
		}
		...
		private class InternalGump2 : Gump
		{
			...
			public InternalGump2( Mobile from, SmallReward2 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
