...
{
	public class SmallReward3 : Item
	{
		...
		[Constructable]
		public SmallReward3() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public SmallReward3( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump3( from, this ) );
			}
		}

		private class InternalGump3 : Gump
		{

			public InternalGump3( Mobile from, SmallReward3 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
