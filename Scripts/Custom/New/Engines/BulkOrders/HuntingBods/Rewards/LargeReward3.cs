...
{
	public class LargeReward3 : Item
	{
		...
		[Constructable]
		public LargeReward3() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public LargeReward3( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump8( from, this ) );
			}
		}

		private class InternalGump8 : Gump
		{

			public InternalGump8( Mobile from, LargeReward3 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
