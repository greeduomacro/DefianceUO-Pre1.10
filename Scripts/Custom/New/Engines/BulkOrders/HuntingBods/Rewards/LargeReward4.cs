...
{
	public class LargeReward4 : Item
	{
		...
		[Constructable]
		public LargeReward4() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public LargeReward4( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump9( from, this ) );
			}
		}

		private class InternalGump9 : Gump
		{

			public InternalGump9( Mobile from, LargeReward4 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
