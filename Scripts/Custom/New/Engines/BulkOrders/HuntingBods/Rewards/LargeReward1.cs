...
{
	public class LargeReward1 : Item
	{
		...
		[Constructable]
		public LargeReward1() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public LargeReward1( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump6( from, this ) );
			}
		}

		private class InternalGump6 : Gump
		{

			public InternalGump6( Mobile from, LargeReward1 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
