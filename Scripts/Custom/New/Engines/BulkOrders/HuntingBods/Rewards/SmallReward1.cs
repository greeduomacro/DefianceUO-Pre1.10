...
{
	public class SmallReward1 : Item
	{
		...
		[Constructable]
		public SmallReward1() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public SmallReward1( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump1 : Gump
		{
			...
			public InternalGump1( Mobile from, SmallReward1 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
