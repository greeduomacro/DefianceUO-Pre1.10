...
{
	public class LargeReward5 : Item
	{
		...
		[Constructable]
		public LargeReward5() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public LargeReward5( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump10( from, this ) );
			}
		}

		private class InternalGump10 : Gump
		{

			public InternalGump10( Mobile from, LargeReward5 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
