...
{
	public class SmallReward4 : Item
	{
		...
		[Constructable]
		public SmallReward4() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public SmallReward4( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new InternalGump4( from, this ) );
			}
		}

		private class InternalGump4 : Gump
		{

			public InternalGump4( Mobile from, SmallReward4 ticket ) : base( 50, 50 )
			{
			Closable=true;
			Disposable=true;
			Dragable=true;
