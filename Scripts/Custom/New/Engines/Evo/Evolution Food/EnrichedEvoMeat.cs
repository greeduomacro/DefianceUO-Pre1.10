...
{
	public class EnrichedPointsTarget : Target
	{
		private EnrichedEvoMeat m_Deed;

		public EnrichedPointsTarget( EnrichedEvoMeat deed ) : base( 18, false, TargetFlags.None )
		{
			m_Deed = deed;
		}
	...
	public class EnrichedEvoMeat : Item
	{
		...
		[Constructable]
		public EnrichedEvoMeat() : this( 1000000 )
		{
		}

		[Constructable]
		public EnrichedEvoMeat( int points ) : base( 0x977 )
		{
			Weight = 7.0;
			Name = "enriched evolution bacon";
			Hue = 2213;
			m_Points = points;
		}

		public EnrichedEvoMeat( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				from.Target = new EnrichedPointsTarget( this );
			}
		}
	}
}