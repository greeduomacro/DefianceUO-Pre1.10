...
namespace Server.Gumps
{
	...
	public class SeerGump : Gump
	{
		/*###############################################
		  ###############################################

		  This is to toggle listing active clients
		  If set to 1, all clients are listed (no matter if hidden or not)
		  If se to 0 the gms are displayed a message saying to use
		  [who instead.

		  ###############################################
		  ############################################### */
		private const int ListClients = 1;

		//################################################
		private Mobile m_From;
		private SeerGumpPage m_PageType;
		...
		public void AddPageButton( int x, int y, int buttonID, string text, SeerGumpPage page, params SeerGumpPage[] subPages )
		{
		...
		{
			Commands.Register( "Seer", AccessLevel.Seer, new CommandEventHandler( Admin_OnCommand ) );
		}
		...
		{
			e.Mobile.SendGump( new SeerGump( e.Mobile, SeerGumpPage.Clients, 0, null, null, null ) );
		}
		...
		public SeerGump( Mobile from, SeerGumpPage pageType, int listPage, ArrayList list, string notice, object state ) : base( 50, 40 )
		{
			from.CloseGump( typeof( SeerGump ) );
			...
			AddPageButton( 10, 10, GetButtonID( 0, 0 ), "INFORMATION", SeerGumpPage.Information );
			AddPageButton( 10, 30, GetButtonID( 0, 1 ), "ADMINISTER", SeerGumpPage.Administer, SeerGumpPage.Administer_Access, SeerGumpPage.Administer_Commands, SeerGumpPage.Administer_Server, SeerGumpPage.Administer_WorldBuilding, SeerGumpPage.Administer_Access_Lockdown );
			AddPageButton( 10, 50, GetButtonID( 0, 2 ), "CLIENT LIST", SeerGumpPage.Clients, SeerGumpPage.ClientInfo );
			AddPageButton( 10, 70, GetButtonID( 0, 3 ), "ACCOUNT LIST", SeerGumpPage.Accounts, SeerGumpPage.Accounts_Shared, SeerGumpPage.AccountDetails, SeerGumpPage.AccountDetails_Information, SeerGumpPage.AccountDetails_Characters, SeerGumpPage.AccountDetails_Access, SeerGumpPage.AccountDetails_Access_ClientIPs, SeerGumpPage.AccountDetails_Access_Restrictions, SeerGumpPage.AccountDetails_Comments, SeerGumpPage.AccountDetails_Tags, SeerGumpPage.AccountDetails_ChangeAccess, SeerGumpPage.AccountDetails_ChangePassword );
			AddPageButton( 10, 90, GetButtonID( 0, 4 ), "FIREWALL", SeerGumpPage.Firewall, SeerGumpPage.FirewallInfo );
			...
			switch ( pageType )
			{
				...
				case SeerGumpPage.Administer_WorldBuilding:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Area Denied for Seers /Regards XLX" ), LabelColor32 ), false, false );

					goto case SeerGumpPage.Administer;
				}
				case SeerGumpPage.Administer_Server:
				{
					AddLabel( 20, 215, LabelHue, "Area Denied to Seers /Regards XLX" );
				...
				case SeerGumpPage.Administer_Access_Lockdown:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Server Lockdown" ), LabelColor32 ), false, false );

					AddHtml( 20, 150, 380, 80, Color( "Disabled for Seers", LabelColor32 ), false, false );

					goto case SeerGumpPage.Administer;
				}
				case SeerGumpPage.Administer_Access:
				{
				...
				case SeerGumpPage.Administer_Commands:
				{
				...
				case SeerGumpPage.Administer:
				{
					AddPageButton( 200, 20, GetButtonID( 3, 0 ), "World Building", SeerGumpPage.Administer_WorldBuilding );
					AddPageButton( 200, 40, GetButtonID( 3, 1 ), "Server", SeerGumpPage.Administer_Server );
					AddPageButton( 200, 60, GetButtonID( 3, 2 ), "Access", SeerGumpPage.Administer_Access, SeerGumpPage.Administer_Access_Lockdown );
					AddPageButton( 200, 80, GetButtonID( 3, 3 ), "Commands", SeerGumpPage.Administer_Commands );

					break;
				}
				case SeerGumpPage.Clients:
				{
					if ( ListClients == 0 )
					{
						//AddLabel( 12, 140, LabelHue, "Seers must use the [who command." );
					}
					else
					{
						...
						if ( m_List == null )
						{
                            ...
                            ArrayList netstateInstances = NetState.Instances;

                            foreach (NetState netState in netstateInstances)
                                if (
                                    netState != null && netState.Mobile != null &&
                                    (netState.Mobile.AccessLevel <= from.AccessLevel || !netState.Mobile.Hidden)
                                ) m_List.Add(netState);
				...
				case SeerGumpPage.Accounts_Shared:
				{
					if ( m_List == null )
				...
				case SeerGumpPage.Accounts:
				{
					if ( m_List == null )
					{
                        //m_List = new ArrayList( Accounts.Table.Values );
                        m_List = new ArrayList();//Al: Displaying all 10000000000000 causes 2sec-lagspikes
					...
					for ( int i = 0, index = (listPage * 12); i < 12 && index >= 0 && index < m_List.Count; ++i, ++index )
					{
						...
						if ( online )
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Use [who" );
						else if ( a.Banned )
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Use [who" );
						else
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Use [who" );
				...
				case SeerGumpPage.AccountDetails:
				{
					AddPageButton( 190, 10, GetButtonID( 5, 0 ), "Information", SeerGumpPage.AccountDetails_Information, SeerGumpPage.AccountDetails_ChangeAccess, SeerGumpPage.AccountDetails_ChangePassword );
					AddPageButton( 190, 30, GetButtonID( 5, 1 ), "Characters", SeerGumpPage.AccountDetails_Characters );
					AddPageButton( 190, 50, GetButtonID( 5, 13 ), "Access", SeerGumpPage.AccountDetails_Access, SeerGumpPage.AccountDetails_Access_ClientIPs, SeerGumpPage.AccountDetails_Access_Restrictions );
					AddPageButton( 190, 70, GetButtonID( 5, 2 ), "Comments", SeerGumpPage.AccountDetails_Comments );
					AddPageButton( 190, 90, GetButtonID( 5, 3 ), "Tags", SeerGumpPage.AccountDetails_Tags );
					break;
				}
				case SeerGumpPage.AccountDetails_ChangePassword:
				{
					...
					goto case SeerGumpPage.AccountDetails;
				}
				case SeerGumpPage.AccountDetails_ChangeAccess:
				{
					Account a = state as Account;
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Disabled for Seers" ), LabelColor32 ), false, false );

					goto case SeerGumpPage.AccountDetails;
				}
				case SeerGumpPage.AccountDetails_Information:
				{
					Account a = state as Account;
				...
				case SeerGumpPage.AccountDetails_Access:
				{
					Account a = state as Account;
					...
					AddPageButton( 20, 150, GetButtonID( 5, 14 ), "View client addresses", SeerGumpPage.AccountDetails_Access_ClientIPs );
					AddPageButton( 20, 170, GetButtonID( 5, 15 ), "Manage restrictions", SeerGumpPage.AccountDetails_Access_Restrictions );

					goto case SeerGumpPage.AccountDetails;
				}
				case SeerGumpPage.AccountDetails_Access_ClientIPs:
				{
					Account a = state as Account;
					...
					goto case SeerGumpPage.AccountDetails_Access;
				}
				case SeerGumpPage.AccountDetails_Access_Restrictions:
				{
					Account a = state as Account;
				...
				case SeerGumpPage.AccountDetails_Characters:
				{
					Account a = state as Account;
				...
				case SeerGumpPage.AccountDetails_Comments:
				{
					Account a = state as Account;
				...
				case SeerGumpPage.AccountDetails_Tags:
				{
					Account a = state as Account;
				...
				case SeerGumpPage.FirewallInfo:
				{
					AddFirewallHeader();
		...
		public static void BanShared_Callback( Mobile from, bool okay, object state )
		{
			...
			from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, notice, state ) );
		}
		...
		public static void AccountDelete_Callback( Mobile from, bool okay, object state )
		{
			...
			if ( okay )
			{
				...
				from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, 0, null, String.Format( "{0} : The account has been deleted.", a.Username ), null ) );
			}
			else
			{
				from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, "You have chosen not to delete the account.", state ) );
			}
		}
		...
		public static void ResendGump_Callback( Mobile from, object state )
		{
			...
			from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, page, list, null, rads ) );
		}
		...
		public static void Firewall_Callback( Mobile from, bool okay, object state )
		{
			...
			from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, notice, a ) );
		}
		...
		public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
		{
			...
			if ( m_PageType == SeerGumpPage.Accounts )
			{
			...
			switch ( type )
			{
				case 0:
				{
					...
					switch ( index )
					{
						//case 0: page = SeerGumpPage.Information; break;
						case 1: page = SeerGumpPage.Administer; break;
						case 2: page = SeerGumpPage.Clients; break;
						case 3: page = SeerGumpPage.Accounts; break;
						case 4: page = SeerGumpPage.Firewall; break;
						default: return;
					}

					from.SendGump( new SeerGump( from, page, 0, null, null, null ) );
					break;
				}
				case 1:
				{
					switch ( index )
					{
						case 0:
						{
							if ( m_List != null && m_ListPage > 0 )
								from.SendGump( new SeerGump( from, m_PageType, m_ListPage - 1, m_List, null, m_State ) );
				...
				{
					string notice = null;
					SeerGumpPage page = SeerGumpPage.Administer;

					if ( index >= 500 )
						page = SeerGumpPage.Administer_Access_Lockdown;
					else if ( index >= 400 )
						page = SeerGumpPage.Administer_Commands;
					else if ( index >= 300 )
						page = SeerGumpPage.Administer_Access;
					else if ( index >= 200 )
						page = SeerGumpPage.Administer_Server;
					else if ( index >= 100 )
						page = SeerGumpPage.Administer_WorldBuilding;

					switch ( index )
					{
						case  0: page = SeerGumpPage.Administer_WorldBuilding; break;
						case  1: page = SeerGumpPage.Administer_Server; break;
						case  2: page = SeerGumpPage.Administer_Access; break;
						case  3: page = SeerGumpPage.Administer_Commands; break;
						...
						case 303: page = SeerGumpPage.Administer_Access_Lockdown; break;
						...
						case 419: InvokeCommand( "MTele" ); notice = "Choose your destination."; break;
					...
					from.SendGump( new SeerGump( from, page, 0, null, notice, null ) );
					...
					switch ( index )
					{
						...
						case 1:
						{
							...
							else
							{
								...
								for ( int i = 0; i < instances.Count; ++i )
								{
                                    ...
                                    if (isMatch && (ns.Mobile.AccessLevel <= from.AccessLevel || !ns.Mobile.Hidden))
                                        results.Add( ns );
								}
							...
							if ( results.Count == 1 )
							{
								...
								if ( state is Mobile )
									from.SendGump( new SeerGump( from, SeerGumpPage.ClientInfo, 0, null, "One match found.", state ) );
								else if ( state is Account )
									from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, "One match found.", state ) );
								else
									from.SendGump( new SeerGump( from, SeerGumpPage.Clients, 0, results, "One match found.", null ) );
							}
							else
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.Clients, 0, results, notice == null ? (results.Count == 0 ? "Nothing matched your search terms." : null) : notice, null ) );
							}
						...
						default:
						{
							...
							if ( m_List != null && index >= 0 && index < m_List.Count )
							{
								...
								if ( m != null )
									from.SendGump( new SeerGump( from, SeerGumpPage.ClientInfo, 0, null, null, m ) );
								else if ( a != null )
									from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, null, a ) );
							}
				...
				case 5:
				{
					switch ( index )
					{
						case 0: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, null, m_State ) ); break;
						case 1: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Characters, 0, null, null, m_State ) ); break;
						case 2: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Comments, 0, null, null, m_State ) ); break;
						case 3: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Tags, 0, null, null, m_State ) ); break;
						case 13: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access, 0, null, null, m_State ) ); break;
						case 14: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, null, m_State ) ); break;
						case 15: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_Restrictions, 0, null, null, m_State ) ); break;
						...
						case 6:
						{
							...
							from.SendGump( new SeerGump( from, dispAccount != null ? SeerGumpPage.AccountDetails_Information : m_PageType, m_ListPage, m_List, notice, dispAccount != null ? dispAccount : m_State ) );
							break;
						}
						case 7:
						{
							...
							if ( results.Count == 1 )
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, "One match found.", results[0] ) );
							else
								from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, 0, results, notice == null ? (results.Count == 0 ? "Nothing matched your search terms." : null) : notice, new ArrayList() ) );

							break;
						}
						case 8: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_ChangePassword, 0, null, null, m_State ) ); break;
						case 9: from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_ChangeAccess, 0, null, null, m_State ) ); break;
						case 10: case 11:
						{
							...
							from.SendGump( new SeerGump( from, m_PageType, m_ListPage, m_List, String.Format( "The account has been {0}.", a.Banned ? "banned" : "unbanned" ), m_State ) );
							break;
						}
						case 12:
						{
							...
							string notice;
							SeerGumpPage page = SeerGumpPage.AccountDetails_ChangePassword;
							...
							else
							{
								...
								a.PlainPassword = password;
								page = SeerGumpPage.AccountDetails_Information;
								CommandLogging.WriteLine( from, "{0} {1} changing password of account {2}", from.AccessLevel, CommandLogging.Format( from ), a.Username );
							}

							from.SendGump( new SeerGump( from, page, 0, null, notice, m_State ) );
						...
						case 16: // view shared
						{
							...
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, 0, list, null, new ArrayList() ) );
							}
							else if ( a.LoginIPs.Length > 0 )
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, "There are no other accounts which share an address with this one.", m_State ) );
							}
							else
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, "This account has not yet been accessed.", m_State ) );
							}
						...
						case 17: // ban shared
						{
							...
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, "There are no accounts which share an address with this one.", m_State ) );
							}
							else
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, "This account has not yet been accessed.", m_State ) );
						...
						case 19: // add
						{
							...
							from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_Restrictions, 0, null, notice, m_State ) );
						...
						case 24:
						{
							...
							from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, "The access level has been changed.", m_State ) );
						...
						{
							from.SendGump( new SeerGump( from, SeerGumpPage.Accounts_Shared, 0, null, null, null ) );
							break;
						}
						case 27: // Ban marked
						{
						...
						case 29: // Mark all
						{
							...
							from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, m_ListPage, m_List, null, new ArrayList( list ) ) );
						...
						case 30: // View all empty accounts
						{
							...
							if ( results.Count == 1 )
								...
								from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, 0, results, (results.Count == 0 ? "Nothing matched your search terms." : null), new ArrayList() ) );
							...
							else
							{
								...
								if ( m_List != null && index >= 0 && index < m_List.Count )
								{
									if ( m_List[index] is Account )
										from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, null, m_List[index] ) );
									else if ( m_List[index] is DictionaryEntry )
										from.SendGump( new SeerGump( from, SeerGumpPage.Accounts, 0, (ArrayList)(((DictionaryEntry)m_List[index]).Value), null, new ArrayList() ) );
								}
							}
				...
				case 6:
				{
					switch ( index )
					{
						case 0:
						{
							...
							if ( results.Count == 1 )
								from.SendGump( new SeerGump( from, SeerGumpPage.FirewallInfo, 0, null, "One match found.", results[0] ) );
							else if ( results.Count > 1 )
								from.SendGump( new SeerGump( from, SeerGumpPage.Firewall, 0, results, String.Format( "Search results for : {0}", match ), m_State ) );
							else
								from.SendGump( new SeerGump( from, m_PageType, m_ListPage, m_List, notice == null ? "Nothing matched your search terms."  : notice, m_State ) );
						...
						case 1:
						{
							...
							if ( text == null || text.Length == 0 )
							{
								from.SendGump( new SeerGump( from, m_PageType, m_ListPage, m_List, "You must enter an address or pattern to add.", m_State ) );
							}
							else if ( !Utility.IsValidIP( text ) )
							{
								from.SendGump( new SeerGump( from, m_PageType, m_ListPage, m_List, "That is not a valid address or pattern.", m_State ) );
							}
							else
							{
								object toAdd;
								...
								Firewall.Add( toAdd );
								from.SendGump( new SeerGump( from, SeerGumpPage.FirewallInfo, 0, null, String.Format( "{0} : Added to firewall.", toAdd ), toAdd ) );
							}
						...
						case 2:
						{
							...
							from.SendGump( new SeerGump( from, m_PageType, m_ListPage, m_List, "Target the player to firewall.", m_State ) );
							break;
						}
						case 3:
						{
							if ( m_State is IPAddress || m_State is String )
							{
								...
								Firewall.Save();
								from.SendGump( new SeerGump( from, SeerGumpPage.Firewall, 0, null, String.Format( "{0} : Removed from firewall.", m_State ), null ) );
							}
						...
						default:
						{
							...
							if ( m_List != null && index >= 0 && index < m_List.Count )
								from.SendGump( new SeerGump( from, SeerGumpPage.FirewallInfo, 0, null, null, m_List[index] ) );
				...
				case 7:
				{
					...
					switch ( index )
					{
						...
						case 2:
						{
							if ( m_From.AccessLevel < m.AccessLevel )
							{
								NetState ns = m.NetState;
						...
						case 14:
						{
							if ( m_From.AccessLevel < m.AccessLevel )
							{
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Information, 0, null, null, m.Account ) );
								sendGump = false;
							}
							break;
						}
					...
					if ( sendGump )
						from.SendGump( new SeerGump( from, SeerGumpPage.ClientInfo, 0, null, notice, m_State ) );
				...
				case 8:
				{
					if ( m_List != null && index >= 0 && index < m_List.Count )
					{
						...
						if ( m_PageType == SeerGumpPage.AccountDetails_Access_ClientIPs )
						{
						...
						else if ( m_PageType == SeerGumpPage.AccountDetails_Access_Restrictions )
						{
							...
							from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_Restrictions, 0, null, String.Format( "{0} : Removed from list.", m_List[index] ), a ) );
						}
					}
					...
					if ( m_List != null && index >= 0 && index < m_List.Count )
					{
						if ( m_PageType == SeerGumpPage.AccountDetails_Access_ClientIPs )
						{
							...
							if ( list.Count > 1 || (list.Count == 1 && !list.Contains( a )) )
								...
								from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Access_ClientIPs, 0, null, "There are no other accounts which share that address.", m_State ) );
						}
					}
		...
		private class AddCommentPrompt : Prompt
		{
			...
			{
				from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Comments, 0, null, "Request to add comment was canceled.", m_Account ) );
			}
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Account != null )
				{
					...
					from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Comments, 0, null, "Comment added.", m_Account ) );
				}
			}
		}
		...
		private class AddTagNamePrompt : Prompt
		{
			...
			public override void OnCancel( Mobile from )
			{
				from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Tags, 0, null, "Request to add tag was canceled.", m_Account ) );
			}
		...
		private class AddTagValuePrompt : Prompt
		{
			...
			public override void OnResponse( Mobile from, string text )
			{
				if ( m_Account != null )
				{
					...
					from.SendGump( new SeerGump( from, SeerGumpPage.AccountDetails_Tags, 0, null, "Tag added.", m_Account ) );
				}
			}
		}
