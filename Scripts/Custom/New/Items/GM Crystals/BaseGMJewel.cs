...
namespace Server.Items
{
	public abstract class BaseGMJewel : Item
	{
		...
		{
			private static SpellInfo m_Info = new SpellInfo( "Staff Hide", "", SpellCircle.Second, 230 );
		...
		{
			private static SpellInfo m_Info = new SpellInfo( "Staff Hide", "", SpellCircle.Second, 263 );
