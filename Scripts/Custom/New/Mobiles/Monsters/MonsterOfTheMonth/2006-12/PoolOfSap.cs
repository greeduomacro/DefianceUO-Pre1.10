...
namespace Server.Items
{
	public class PoolOfSap : Item
	{
		...
		[Constructable]
		public PoolOfSap() : this( TimeSpan.FromSeconds( 10.0 ), 2, 5 )
		{
		}

		[Constructable]
		public PoolOfSap( TimeSpan duration, int minDamage, int maxDamage )
			: base( 0x122A )
		{
			Hue = 48;
			Name = "a pool of hot sap";
			Movable = false;
		...
		public PoolOfSap( Serial serial ) : base( serial )
		{
		}
