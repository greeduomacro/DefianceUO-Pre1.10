...
namespace Server.Items
{
		public class PixieStatue : Item
	{
		...
		[Constructable]
		public PixieStatue() : this( 0x25B6 )
		{
		}

		[Constructable]
		public PixieStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 11;
			Name = "a pixie statue";
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 1133, 1134, 1135, 1136, 1137, 1138 ));
			}

			base.OnMovement( m, oldLocation );
		}

		public PixieStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private PixieStatue m_Statuette;

			public OnOffGump( PixieStatue statuette ) : base( 150, 200 )
			{
