...
namespace Server.Items
{
	public class CatStatue : Item
	{
		...
		[Constructable]
		public CatStatue() : this( 0x2119 )
		{
		}

		[Constructable]
		public CatStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 5;
			Name = "a cat statue";
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				string[] mouse = {"I ate the mouse!", "That mouse tasted so good!", "mmmm mice....", "Feed me more Mice!", "I want to hunt that mouse again!"};
		...
		public CatStatue( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnSingleClick( Mobile from )
		{
			if ( IsLockedDown )
			{
				string[] touch = {"Get off me human!", "I dont like being touched there!", "No!", "Left a bit, no thats too far!", "Leave my tail alone!"};
				if ( 25 > Utility.Random( 100 ) )
				{
		...
		{
			private CatStatue m_Statuette;

			public OnOffGump( CatStatue statuette ) : base( 150, 200 )
			{
