...
{
		public class RainbowSpiderStatue : Item
	{
		...
		[Constructable]
		public RainbowSpiderStatue() : this( 0x25C4 )
		{
		}

		[Constructable]
		public RainbowSpiderStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 11;
			Name = "a rainbow spider statue";
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 0x388, 0x389 ) );
		...
		public RainbowSpiderStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private RainbowSpiderStatue m_Statuette;

			public OnOffGump( RainbowSpiderStatue statuette ) : base( 150, 200 )
			{
