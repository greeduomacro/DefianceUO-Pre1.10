...
{
	[CorpseName( "a servents corpse" )]
	public class DecayingSpawn : BaseCreature
	{
		private Mobile m_Owner;
		private DateTime m_ExpireTime;

		[Constructable]
		public DecayingSpawn ( Mobile owner ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a loyal servent";
			...
			SetSkill( SkillName.Poisoning, 100.1, 105.0 );
		...
		public DecayingSpawn( Serial serial ) : base( serial )
		{
		}
