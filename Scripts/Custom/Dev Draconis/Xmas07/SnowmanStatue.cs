...
{
		public class SnowmanStatue : Item
	{
		...
		[Constructable]
		public SnowmanStatue() : this( 0x20D7 )
		{
		}

		[Constructable]
		public SnowmanStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 6;
			Name = "a snowman statue";
			Hue = 1150;
		}
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 268, 269, 270, 271, 272 ) );
			}

			base.OnMovement( m, oldLocation );
		}

		public SnowmanStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private SnowmanStatue m_Statuette;

			public OnOffGump( SnowmanStatue statuette ) : base( 150, 200 )
			{
