...
{
		public class RaindeerStatue : Item
	{
		...
		[Constructable]
		public RaindeerStatue() : this( 0x1E68 )
		{
		}

		[Constructable]
		public RaindeerStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 6;
			Name = "the head of a raindeer";
			Hue = 1717;
		}
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 0x82, 0x83, 0x84 ) );
			}

			base.OnMovement( m, oldLocation );
		}

		public RaindeerStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private RaindeerStatue m_Statuette;

			public OnOffGump( RaindeerStatue statuette ) : base( 150, 200 )
			{
