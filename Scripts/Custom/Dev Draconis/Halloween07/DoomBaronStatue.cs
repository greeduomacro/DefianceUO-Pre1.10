...
{
		public class DoomBaronStatue : Item
	{
		...
		[Constructable]
		public DoomBaronStatue() : this( 0x2584 )
		{
		}

		[Constructable]
		public DoomBaronStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 6;
			Name = "a baron of doom statue";
			Hue = 1160;
		}
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 357, 358, 359, 360, 361 ) );
			}

			base.OnMovement( m, oldLocation );
		}

		public DoomBaronStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private DoomBaronStatue m_Statuette;

			public OnOffGump( DoomBaronStatue statuette ) : base( 150, 200 )
			{
