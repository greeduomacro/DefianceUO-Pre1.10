...
{
		public class WalkingDeadStatue : Item
	{
		...
		[Constructable]
		public WalkingDeadStatue() : this( 0x25D5 )
		{
		}

		[Constructable]
		public WalkingDeadStatue( int itemID ) : base( itemID )
		{
			Movable = true;
			Weight = 11;
			Name = "statue of the walking dead";
			Hue = 1196;
		}
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				Effects.PlaySound( this.Location, this.Map, Utility.RandomList( 471, 472, 473, 474, 475 ) );
			}

			base.OnMovement( m, oldLocation );
		}

		public WalkingDeadStatue( Serial serial ) : base( serial )
		{
		}
		...
		{
			private WalkingDeadStatue m_Statuette;

			public OnOffGump( WalkingDeadStatue statuette ) : base( 150, 200 )
			{
