...
namespace Server.Mobiles
{
	...
	public class DummySuperPlayerSided : Dummy
	{

		[Constructable]
		public DummySuperPlayerSided() : base(AIType.AI_Mage, FightMode.Evil, 15, 1, 0.2, 0.6)
		{
			// A Dummy Super Mage
			int iHue = 1141;
			int jHue = 1141;
			...
			HoodedShroudOfShadows HoodedShroud = new HoodedShroudOfShadows();
			HoodedShroud.Hue = NewHue;
			HoodedShroud.LootType = LootType.Newbied;
		...
		public DummySuperPlayerSided( Serial serial ) : base( serial )
		{
		}
	...
	public class DummyEvilBackup : Dummy
	{

		[Constructable]
		public DummyEvilBackup() : base(AIType.AI_Mage, FightMode.Evil, 15, 1, 0.2, 0.6)
		{
			// A Dummy Super Mage
			int iHue = 1109;
			int jHue = 1109;
		...
		public DummyEvilBackup( Serial serial ) : base( serial )
		{
		}
