...
namespace Server.Mobiles
{
	public class MageAI : BaseAI
	{
		...
		private const double HealChance = 0.00; // 10% chance to heal at gm magery
		...
		public virtual Spell ChooseSpell( Mobile c )
		{
			if ( !SmartAI )
			{
				...
				Spell randspell = GetRandomDamageSpell();
				while ( ( m_Mobile is IEvoCreature || m_Mobile is EvolutionDragon ) && c is PlayerMobile && ( randspell is PoisonSpell || randspell is ParalyzeSpell ) )
					randspell = GetRandomDamageSpell();
			...
			switch ( Utility.Random( 4 + healChance ) )
			{
				...
				case 2: // Deal some damage
				{
					...
					while ( ( m_Mobile is IEvoCreature || m_Mobile is EvolutionDragon ) && c is PlayerMobile && ( spell is PoisonSpell || spell is ParalyzeSpell ) )
						spell = GetRandomDamageSpell();
