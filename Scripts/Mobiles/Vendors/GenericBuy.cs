	...
	public class GenericBuyInfo : IBuyItemInfo
	{
		private class DisplayCache : Container
		{
			...
			public override void Serialize( GenericWriter writer )
			{
				...
				writer.WriteMobileList( m_Mobiles == null ? ms_EmptyArrayList :  m_Mobiles, true );
			}
			...
			public override void Deserialize( GenericReader reader )
			{
				...
				m_Mobiles = reader.ReadMobileList(); //SunUO: ReadMobileListOrNull()
		...
		private int m_Price;
		// jakob, made these protected
		protected int m_MaxAmount, m_Amount;
		// end
