...
namespace Server.Mobiles
{
    public class Weaver : BaseVendor
    {
        ...
        public override Item CreateBulkOrder(Mobile from, bool fromContextMenu)
        {
            ...
            if (pm != null && pm.NextTailorBulkOrder == TimeSpan.Zero && (fromContextMenu || 0.3 > Utility.RandomDouble()))
            {
        ...
        {
            return (from is PlayerMobile && CanReceiveBulkOrder((PlayerMobile)from, SkillName.Tailoring));//Edited by Sunny
        }
