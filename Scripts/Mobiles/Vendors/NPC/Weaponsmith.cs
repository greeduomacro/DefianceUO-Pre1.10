...
namespace Server.Mobiles
{
    public class Weaponsmith : BaseVendor
    {
        ...
        public override Item CreateBulkOrder(Mobile from, bool fromContextMenu)
        {
            ...
            if (pm != null && pm.NextSmithBulkOrder == TimeSpan.Zero && (fromContextMenu || 0.3 > Utility.RandomDouble()))
            {
        ...
        {
            return (from is PlayerMobile && CanReceiveBulkOrder((PlayerMobile)from, SkillName.Blacksmith));//Edited by Sunny
        }
