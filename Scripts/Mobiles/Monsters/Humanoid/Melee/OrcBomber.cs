...
namespace Server.Mobiles
{
	...
	public class OrcBomber : BaseCreature
	{
		...
		public OrcBomber() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			PackItem( new SulfurousAsh( Utility.RandomMinMax( 1, 10 ) ) );
			PackItem( new MandrakeRoot( Utility.RandomMinMax( 1, 10 ) ) );
			PackItem( new BlackPearl( Utility.RandomMinMax( 1, 10 ) ) );
