...
namespace Server.Mobiles
{
	...
	public class Savage : BaseCreature
	{
		...
		public Savage() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Fencing, 60.0, 72.5 );
			SetSkill( SkillName.MagicResist, 67.5, 71.0 );
			SetSkill( SkillName.Tactics, 68.0, 72.5 );
			...
			if ( Female && 0.2 > Utility.RandomDouble() )
				PackItem( new TribalBerry() );
			else if ( !Female && 0.2 > Utility.RandomDouble() )
