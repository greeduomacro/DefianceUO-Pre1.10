...
namespace Server.Mobiles
{
	...
	public class SavageShaman : BaseCreature
	{
		...
		public SavageShaman() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.EvalInt, 57.5, 60.0 );
			SetSkill( SkillName.Magery, 82.5, 85.0 );
			SetSkill( SkillName.Meditation, 47.5, 50.0 );
			SetSkill( SkillName.MagicResist, 77.5, 80.0 );
			...
			PackWeapon( 0, 3 );
			PackReg( 2, 10 );
			PackItem( new Bandage( Utility.RandomMinMax( 2, 15 ) ) );
