...
namespace Server.Mobiles
{
	public class Banker : BaseVendor
	{
        ...
        private bool m_LOSCheck;

        [CommandProperty( AccessLevel.GameMaster )]
        public bool LOSCheck
        {
            get { return m_LOSCheck; }
            set { m_LOSCheck = value; }
        }
		...
		{
			if ( !e.Handled && e.Mobile.InRange( this.Location, 12 ) && (!m_LOSCheck || InLOS(e.Mobile)))
			{
