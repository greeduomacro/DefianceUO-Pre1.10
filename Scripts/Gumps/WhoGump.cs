...
namespace Server.Gumps
{
	public class WhoGump : Gump
	{
		...
		{
			Commands.Register( "Who", AccessLevel.Seer, new CommandEventHandler( WhoList_OnCommand ) );
			Commands.Register( "WhoList", AccessLevel.Seer, new CommandEventHandler( WhoList_OnCommand ) );
		}
