...
namespace Server
{
	public class DefensiveSpell
	{
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer( Mobile m ) : base( TimeSpan.FromMinutes( 2.0 ) )
			{
				m_Mobile = m;
...
namespace Server.Spells
{
	...
	public class SpellHelper
	{
		...
		public static TimeSpan[] DamageDelays = new TimeSpan[8]
			{
				/* New Values: */
				/* Lv1 To Lv8 (top bottom) */
...
/* Recall From */	{ true,		true,			true,		false,		true,			true,			false,		false,				false,				false,				true },
/* Recall To */		{ true,		true,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Gate From */		{ true,		false,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Gate To */		{ true,		false,			false,		false,		true,			false,			false,		false,				false,				false,				false },
/* Mark In */		{ true,		false,			false,		false,		true,			false,			false,		false,				false,				false,				false },
			...
			if ( target.MagicDamageAbsorb > 0 )
			{
				...
				if ( reflect )
				{
					...
					if ( caster.Spell != null && caster.Spell.IsCasting )
						((Spell)caster.Spell).Disturb( DisturbType.EquipRequest );
				}
			}
