...
namespace Server.Items
{
	public class StatCapScroll : Item
	{
		...
		{
			if ( m_Value == 230 )
				list.Add( "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
			else if ( m_Value == 235 )
				list.Add( "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
			else if ( m_Value == 240 )
				list.Add( "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
		...
		{
			if ( m_Value == 230 )
				base.LabelTo( from, "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
			else if ( m_Value == 235 )
				base.LabelTo( from, "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
			else if ( m_Value == 240 )
				base.LabelTo( from, "a super points scroll  (x{1} To your highest scroll)", (m_Value - 225) >= 0 ? "+" : "", m_Value - 225 );
