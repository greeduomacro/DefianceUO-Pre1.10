...
namespace Server.Items
{
   ...
   public class Moongate : Item
   {
	  ...
	  public virtual void OnGateUsed( Mobile m )
	  {
		 ...
		 {
			m_newTarget = house.BanLocation;

			BaseCreature.TeleportPets( m, m_newTarget, m_TargetMap );
			m.MoveToWorld( m_newTarget, m_TargetMap );
		 }
	  }
