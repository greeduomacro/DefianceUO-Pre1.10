	...
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			if( Core.SE )
			{
				...
				AddRes( index, typeof( Cloth ), 1044286, 60, 1044287 );
                                SetNeedSE( index, true );
                        	AddCraft( typeof( LargeGlowingBeetle3 ), 1044294, "sm glowing ladybug", 59.9, 65.9, typeof( Log ), 1044041, 5, 1044351 );
                        	AddCraft( typeof( LargeGlowingBeetle ), 1044294, "lg glowing beetle east", 80.0, 100.0, typeof( Log ), 1044041, 10, 1044351 );
			        AddCraft( typeof( LargeGlowingBeetle2 ), 1044294, "lg glowing beetle south", 80.0, 100.0, typeof( Log ), 1044041, 10, 1044351 );
			}
			...
			if( Core.SE )
			{
				...
				index = AddCraft( typeof( PlainLowTable ),		1044291, 1030266,	80.0, 105.0,	typeof( Log ), 1044041, 35, 1044351 );
                                SetNeedSE( index, true );
                        	AddCraft( typeof( CozyElvenChair ), 1044291, "cozy elven chair" , 52.6, 77.6, typeof( Log ), 1044041, 17, 1044351 );
                        	AddCraft( typeof( ElvenReadingChair ), 1044291, "elven reading chair" , 52.6, 77.6,	typeof( Log ), 1044041, 17, 1044351 );
                        	AddCraft( typeof( OrnateElvenChair ), 1044291, "ornate elven chair" , 52.6, 77.6,	typeof( Log ), 1044041, 17, 1044351 );
			}
			...
			if( Core.SE )
			{
				...
				SetNeedSE( index, true );
                              AddCraft( typeof( OrnateElvenBox ),	1044292, "ornate elven box", 21.0,  46.0,	typeof( Log ), 1044041, 10, 1044351 );
			      AddCraft( typeof( ElvenStorageTable ), 1044292, "elven storage table" , 10.0,  35.0,	typeof( Log ), 1044041, 8 , 1044351 );
                              AddCraft( typeof( SimpleElvenArmoire ), 1044292, "simple elven armoire" , 47.3,  72.3,	typeof( Log ), 1044041, 18, 1044351 );
			      AddCraft( typeof( FancyElvenArmoire ), 1044292, "fancy elven armoire" , 73.6,  98.6,	typeof( Log ), 1044041, 20, 1044351 );
			      AddCraft( typeof( DisplayCase ), 1044292, "display case" , 84.2, 109.2,	typeof( Log ), 1044041, 35, 1044351 );
			}
