	...
	public abstract class CraftSystem
	{
		...
		public void SetNeedSE( int index, bool needSE )
		{
			...
			craftItem.RequiresSE = needSE;
                ...
                // jakob, added this as a user-friendly way to add a method that is to be checked to see if the player can craft or not
		public void SetHasConditional( int index, ConditionalAvailibility conditional )
		{
			CraftItem craftItem = m_CraftItems.GetAt( index );
			craftItem.Conditional = conditional;
		}
		// end
