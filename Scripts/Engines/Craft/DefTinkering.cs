...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			#region Misc
			AddCraft( typeof( KeyRing ), 1044050, 1011217, 10, 60, typeof( IronIngot ), 1044036, 2, 1044037 );
			...
			// This example will create a wolfrider if you have 10k silver and an ancientsigil in your backpack
			...
			// explosion tinker trap
			index = AddCraft(typeof(ExplosionTinkerTrap), 1044052, "tinker explosion trap", 60, 115, typeof(IronIngot), "iron ingots", 10);
			AddRes(index, typeof(GreaterExplosionPotion), "greater explosion potions", 10);

			// poison tinker trap
			index = AddCraft(typeof(PoisonTinkerTrap), 1044052, "tinker poison trap", 60, 115, typeof(IronIngot), "iron ingots", 10);
			AddRes(index, typeof(DeadlyPoisonPotion), "deadly poison potions", 10);
			#endregion
