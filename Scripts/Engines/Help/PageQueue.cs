...
namespace Server.Engines.Help
{
		...
		private class InternalTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				if ( m_Entry.Sender.NetState != null && index != -1 )
				{
					...
					m_Entry.Sender.SendMessage( "You can reference our website at www.defianceuo.com. To cancel your page, please select the help button again and select cancel." );
				}
				else
				{
	...
	public class PageQueue
	{
		...
		public static bool CheckAllowedToPage( Mobile from )
		{
            ...
            else if (pm.PagingSquelchedTill != DateTime.MinValue)
            {
                from.SendMessage("You cannot request help, sorry.");
                from.SendMessage("Time remaining: {0}.", Misc.AutoRestart.FormatTimeSpan(pm.PagingSquelchedTill - DateTime.Now).ToString());
                return false;
            }
