...
namespace Server.Admin
{
	public class AdminNetwork
	{
		...
		public static void OnReceive( NetState state, PacketReader pvSrc )
		{
			...
			{
				string statStr = String.Format( ", Name={0}, Age={1}, Clients={2}, Items={3}, Chars={4}, Mem={5}K", Server.Misc.ServerList.ServerName, (int)(DateTime.Now-Server.Items.Clock.ServerStart).TotalHours, (int)(NetState.Instances.Count*1.2), World.Items.Count, World.Mobiles.Count, (int)(System.GC.GetTotalMemory(false)/1024) );
