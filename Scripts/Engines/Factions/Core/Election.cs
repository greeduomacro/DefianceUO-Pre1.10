...
namespace Server.Factions
{
	...
	{
		// jakob, changed this from 5.0 to 11.0
	...
	public class Candidate
	{
		...
		// jakob, pimped this up to take into account the length a player has been in a faction
		public int Votes
		{
			get
			{
				...
				foreach ( Voter voter in m_Voters )
				{
					...
					if ( ps != null )
					{
						TimeSpan timeDiff = DateTime.Now - ps.Joined;
