...
namespace Server.Factions
{
	...
	public class FactionWarHorse : BaseMount
	{
		...
		public const int GoldPrice = 7000;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			// jakob, changed this to 1 instead of 2
			//else if ( pl.Rank.Rank < 1 )
			//	from.SendMessage( "You must achieve a faction rank of at least one before riding a war horse!" );
			// end
			else
