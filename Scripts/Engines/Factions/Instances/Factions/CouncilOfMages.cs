			...
			Definition =
				new FactionDefinition(
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionSorceress ),	0x0E89, 3000, 3000, 4,		new TextDefinition( 1011507, "SORCERESS" ),		new TextDefinition( 1011501, "Hire Sorceress" ) ),
						new GuardDefinition( typeof( FactionWizard ),		0x13F8, 4000, 4000, 3,		new TextDefinition( 1011508, "ELDER WIZARD" ),	new TextDefinition( 1011502, "Hire Elder Wizard" ) ),
					}
				);
		}
	}
