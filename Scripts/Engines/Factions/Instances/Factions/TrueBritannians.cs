			...
			Definition =
				new FactionDefinition(
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionKnight ),		0x0F4D, 3000, 3000, 4,		new TextDefinition( 1011528, "KNIGHT" ),		new TextDefinition( 1011497, "Hire Knight" ) ),
						new GuardDefinition( typeof( FactionPaladin ),		0x143F, 4000, 4000, 3,		new TextDefinition( 1011529, "PALADIN" ),		new TextDefinition( 1011498, "Hire Paladin" ) ),
					}
				);
		}
	}
